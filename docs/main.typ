...
#abstract(
  ...
  Дипломный проект: 62 страницы, 15 рисунков, 12 таблиц, 25 источников, 4 приложения.
  ...
  Объект исследования — производственные риски ЗАО «Солигорский институт проблем ресурсосбережения с опытным производлением».
