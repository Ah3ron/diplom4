          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                ...
                прогнозом и p-value, распределение Пуассона с χ²-критерием,
                FMEA-анализ с доверительными интервалами RPN.
                PDF-отчёт содержит графики и диаграммы.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex flex-col gap-4">
            ...
            <CardContent>
              <div className="flex flex-col gap-2 text-sm">
                ...
                <div>
                  ...
                  прогноз с 95% ДИ, p-value значимости, скользящее среднее
                </div>
                <div>
                  <strong>4. Анализ Пуассона</strong> — λ, распределение, P(0),
                  P(≥1), ДИ, критерий согласия χ²
                </div>
                <div>
                  <strong>5. FMEA-анализ</strong> — автоматический расчёт
                  S/O/D, RPN с 95% доверительным интервалом (бутстрэп),
